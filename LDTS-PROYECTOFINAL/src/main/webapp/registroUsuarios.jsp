...
<body>
    <div class="form-box">
        ...
        <form id="login" class="input-group" action="index.html">
            <div class="inp">
                <i class="fa fa-user" style="font-size: 20px;padding-right: 10px;"></i><input type="text" id="emailLogin"
                    class="input-field" placeholder="Email" style="width: 88%; border:none;"
                    required="required">
            </div>
            <div class="inp">
                <i class="fas fa-lock" style="font-size: 20px;padding-right: 10px;"></i><input type="password" id="passwordLogin"
