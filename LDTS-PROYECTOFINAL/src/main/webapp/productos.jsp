    ...
    <div class="landingpage">
        <div class="navbar">
            ...
            <div class="navlinkwrap">
                <a href="index.html" class="nav-item navlink">Home</a>
                ...
                <a href="cesta.html" class="nav-item navlink">Cesta</a>>
            </div>
        </div>
        <div class="box">
            <div class="infobox">
        ...
        <div class="auction">
            ...
            <div class="nft">
                <div class=item>
                    ...
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor">
        ...
        <div class="discover">
            ...
            <div class="discover-items">
                <div class=item>
                    <img class="item-img"
                    <img class="display-nft" src="imagenes/landscape-AI-Art-intergalactic-spaceport-where-spaceships-dock-style-of-Alan-Aldridge.png">
                    <div class="item-title">
                        <p>Lorem Ipsum</p>
                        <p>1.20 Weth</p>
                    </div>
                ...
                <div class=item>
                    <img class="item-img"
                        src="imagenes/ilustraciones-paisajes-paisajes-bosques-montana-ia-generativa_983981-391.avif"
                        alt="unsplash-OG44d93i-NJk" border="0">
                    <div class="item-title">
                        <p>Lorem Ipsum</p>
                        <p>1.20 Weth</p>
                ...
                <div class=item>
                    <img class="item-img" src="imagenes/ai-generated-7695056_1280.jpg" border="0">
                    <div class="item-title">
                        <p>Lorem Ipsum</p>
                        <p>1.20 Weth</p>
                    </div>
                ...
                <div class=item>
                    <img class="item-img"
                        src="imagenes/ilustraciones-paisajes-paisajes-bosques-montana-ia-generativa_983981-389.avif"
                        alt="unsplash-OG44d93i-NJk" border="0">
                    <div class="item-title">
                        <p>Lorem Ipsum</p>
                        <p>1.20 Weth</p>
                ...
                <div class=item>
                    <img class="item-img" src="imagenes/ai-generated-7695056_1280.jpg" alt="unsplash-OG44d93i-NJk"
                        border="0">
                    <div class="item-title">
                        <p>Lorem Ipsum</p>
                        <p>1.20 Weth</p>
                ...
                <div class=item>
                    <img class="item-img"
                        src="imagenes/ai-generated-7695056_1280.jpg"
                        alt="unsplash-OG44d93i-NJk" border="0">
                    <div class="item-title">
                        <p>Lorem Ipsum</p>
                        <p>1.20 Weth</p>
            ...
            <button class="discover-loadbtn">Ver mas</button>
        </div>
        <br><br><hr>
        <div class="footer">
